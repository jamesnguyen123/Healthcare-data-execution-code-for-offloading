# -*- coding: utf-8 -*-
"""
Created on Mon Aug 05 17:21:14 2019
...
def lambda_handler(event, context):
    ...
    if event:
        ...
        if Biokin_score1 >100:
            Biokin_score1=100
        ####################
        q="Entropy value: "+str(Fuzzyround)+","+"Sara score: "+str(Sara_score1)+","+"012 score: "+str(Zero_score1)+","+"SOT score: "+str(SOT_score1)+","+"ABC score: "+str(ABC_score1)+","+"Biokin score: "+str(Biokin_score1)
